...
namespace SimplCommerce.Module.Core.Services
{
    public class ThemeService : IThemeService
    {
        ...
        public ThemeService(IConfiguration configuration, IRepository<AppSetting, string> appSettingRepository)
        {
        ...
        {
            var themeSetting = await _appSettingRepository.GetAll().Where(x => x.Id == SimplConstants.ThemeConfigKey).FirstAsync();
